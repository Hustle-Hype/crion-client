...
export default function MostIgnitedSection({
  ...
  return (
    <section className="relative w-full flex flex-col md:flex-row gap-8 md:gap-0 px-4 md:px-20 bg-[#181a1f] pt-40 pb-20">
      <div className="will-change-opacity absolute h-[414px] overflow-hidden w-[100dvw] left-1/2 -translate-x-1/2 -top-50 mask-[radial-gradient(90%_80%_at_50%_100%,#D9D9D9_80%,rgba(115,115,115,0)_100%)] md:mask-[radial-gradient(50%_65.7%_at_50%_34.3%,#D9D9D9_0%,rgba(115,115,115,0)_100%)]">
        {" "}
