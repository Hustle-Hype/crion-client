...
export default function SimpleCreateTokenPage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const res = await fetch(
        "https://crion.onrender.com/api/v1/issuer/upload/image",
        {
          method: "POST",
          body: formData,
        }
  ...
  const handleCreateToken = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const projectUrlBytes = Array.from(
        new TextEncoder().encode(formData.projectUrl)
      );
      const descriptionBytes = Array.from(
        new TextEncoder().encode(formData.description)
      );
      const assetTypeBytes = Array.from(
        new TextEncoder().encode(formData.assetType)
      );
      const args = [
        symbolBytes,
        nameBytes,
      ...
      const response = await safeWallet.safeSignAndSubmitTransaction(
                      ...
                      >
                        <span className="absolute inset-0 rounded-lg overflow-hidden">
                          <span
                            className={
                              step === i
                                ? "absolute inset-0 rounded-lg bg-gradient-to-r from-[#2563eb] to-[#38bdf8]"
                                : "absolute inset-0 rounded-lg bg-[#212121]"
                            }
                          ></span>
                        </span>
                        <span
                          className={
                            step === i
                              ? "absolute inset-0 rounded-lg border border-white/80"
                              : "absolute inset-0 rounded-lg border border-gradient-to-b from-white/30 to-[#181a1f]/40"
                          }
                        ></span>
                        <span
                          className={
                            step === i
                              ? "absolute inset-0 rounded-lg shadow-[0px_3px_0px_0px_rgba(37,99,235,0.44)]"
                              : "absolute inset-0 rounded-lg shadow-[0px_3px_0px_0px_rgba(255,255,255,0.05)]"
                          }
                        ></span>
        ...
        <div className="w-full lg:w-3/4 p-4 sm:p-6 lg:p-8 rounded-xl bg-[#181a1f] relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {formData.iconUrl && (
                      <img
                        ...
                        className="w-20 h-20 object-cover rounded mt-2 border border-white/10"
                      />
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <label className="text-xs flex items-center gap-2 text-white font-normal mb-2">
                    ...
                    {formData.mintAmount &&
                      formData.decimals !== undefined &&
                      !isNaN(Number(formData.mintAmount)) && (
                        <span className="ml-2 text-white/50">
                          (Example:{" "}
                          {getRealValue(formData.mintAmount, formData.decimals)}{" "}
                          {formData.symbol || ""})
                        </span>
                      )}
                  </label>
                ...
                <div className="space-y-2">
                  <label className="text-xs flex items-center gap-2 text-white font-normal mb-2">
                    ...
                    {formData.buyFee &&
                      formData.decimals !== undefined &&
                      !isNaN(Number(formData.buyFee)) && (
                        <span className="ml-2 text-white/50">
                          (Example:{" "}
                          {getRealValue(formData.buyFee, formData.decimals)}{" "}
                          {formData.symbol || ""})
                        </span>
                      )}
                  </label>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  >
                    ...
                    <option
                      value="REAL_ESTATE"
                      style={{ borderRadius: "1.5rem", padding: "14px 24px" }}
                    >
                      Real Estate
                    </option>
                    <option
                      value="EQUITY_STARTUP"
                      style={{ borderRadius: "1.5rem", padding: "14px 24px" }}
                    >
                      Equity / Startup
                    </option>
                ...
                <div className="space-y-2">
                  <label className="text-xs flex items-center gap-2 text-white font-normal mb-2">
                    ...
                    {formData.backingRatio &&
                      formData.decimals !== undefined &&
                      !isNaN(Number(formData.backingRatio)) && (
                        <span className="ml-2 text-white/50">
                          (Example:{" "}
                          {getRealValue(
                            formData.backingRatio,
                ...
                <div className="space-y-2">
                  <label className="text-xs flex items-center gap-2 text-white font-normal mb-2">
                    ...
                    {formData.withdrawalLimit &&
                      formData.decimals !== undefined &&
                      !isNaN(Number(formData.withdrawalLimit)) && (
                        <span className="ml-2 text-white/50">
                          (Example:{" "}
                          {getRealValue(
                            formData.withdrawalLimit,
                ...
                <div className="space-y-2">
                  <label className="text-xs flex items-center gap-2 text-white font-normal mb-2">
                    Withdrawal Cooldown
                    {formData.withdrawalCooldown &&
                      !isNaN(Number(formData.withdrawalCooldown)) && (
                        <span className="ml-2 text-white/50">
                          (Example:{" "}
                          {getRealValue(
                            formData.withdrawalCooldown,
                ...
                <div className="space-y-2">
                  <label className="text-xs flex items-center gap-2 text-white font-normal mb-2">
                    ...
                    {formData.graduationThreshold &&
                      formData.decimals !== undefined &&
                      !isNaN(Number(formData.graduationThreshold)) && (
                        <span className="ml-2 text-white/50">
                          (Example:{" "}
                          {getRealValue(
                            formData.graduationThreshold,
                ...
                <div className="space-y-2">
                  <label className="text-xs flex items-center gap-2 text-white font-normal mb-2">
                    ...
                    {formData.graduationTarget &&
                      formData.decimals !== undefined &&
                      !isNaN(Number(formData.graduationTarget)) && (
                        <span className="ml-2 text-white/50">
                          (Example:{" "}
                          {getRealValue(
                            formData.graduationTarget,
          ...
          {step === 1 && (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="mb-2 text-white text-sm font-normal">
                    Email (Optional)
                  </label>
                  <Input
                    name="email"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder="e.g. x.com/yourname"
                  />
                </div>
                <div className="space-y-2">
                  <label className="mb-2 text-white text-sm font-normal">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder="e.g. discord.gg/yourserver"
                  />
                </div>
              </div>
              <div className="flex justify-end gap-4 pt-6">
                <Button
                  type="button"
                  variant="outline"
                  className="w-[160px] bg-[#212121] text-white border border-white/20 shadow-md"
                  onClick={handleBack}
                >
                  Back
                </Button>
          ...
          {step === 2 && (
            ...
            >
              <div className="space-y-1 sm:space-y-2">
                ...
                <p className="text-white/[0.4] text-sm sm:text-base">
                  Verify the details below. You can go back to edit any section
                  before proceeding
                </p>
              </div>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2 sm:gap-4">
                    <h3 className="text-base sm:text-lg font-normal text-[#A7A7A7]">
                      Asset Information
                    </h3>
                  </div>
                </div>
                <div className="px-4 sm:px-10 space-y-4">
                  <div className="flex flex-col sm:flex-row sm:gap-8 space-y-6 sm:space-y-0">
                    <div className="flex flex-col items-start">
                      <div className="text-white/[0.4] text-sm sm:text-base mb-2 flex items-center gap-2">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    <span className="text-white/[0.4] text-sm sm:text-base sm:w-[240px] sm:flex-shrink-0">
                      Asset Type
                    </span>
                    <span className="text-white/[0.64] text-base font-medium">
                      {formData.assetType}
                    </span>
                  </div>
                ...
                <div className="px-4 sm:px-10 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-gradient-to-r from-purple-500 to-indigo-500"></div>
                      <span className="text-white/[0.64] text-base font-medium">
                        Base Aptos
                      </span>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-4">
                    ...
                    <span className="text-white/[0.64] text-base font-medium break-all sm:truncate sm:max-w-md">
                      {(() => {
                        if (!connectedWallet.account) return "-";
                        if (typeof connectedWallet.account === "string")
                          return connectedWallet.account;
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="px-4 sm:px-10 space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    ...
                    <span className="text-white/[0.64] text-base font-medium">
                      <div className="flex">
                        <span>{formData.mintAmount}</span>
                        <span className="pl-1">RWA</span>
                      </div>
                    </span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="px-4 sm:px-10 space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    ...
                    <span className="text-white/[0.64] text-base font-medium break-all sm:break-normal">
                      {formData.email || "-"}
                    </span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-end gap-3 sm:gap-4 pt-4 sm:pt-6">
                <Button
                  type="button"
                  variant="outline"
                  className="w-full sm:w-[160px] bg-[#212121] text-white border border-white/20 shadow-md"
                  onClick={handleBack}
                >
                  Back
                </Button>
